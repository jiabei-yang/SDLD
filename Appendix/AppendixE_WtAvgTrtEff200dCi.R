...
# time 1
result.tmle.wt200d.1 <- ltmle(finalData.noMiss.t0Jul2016.switchDTG.wt200d.scaled %>%
...
# time 2
result.tmle.wt200d.2 <- ltmle(finalData.noMiss.t0Jul2016.switchDTG.wt200d.scaled %>%
...
# time 3
result.tmle.wt200d.3 <- ltmle(finalData.noMiss.t0Jul2016.switchDTG.wt200d.scaled %>%
...
# time 4
result.tmle.wt200d.4 <- ltmle(finalData.noMiss.t0Jul2016.switchDTG.wt200d.scaled %>%
...
mean(as.matrix(finalData.noMiss.t0Jul2016.switchDTG.wt200d %>%
...
n0.wt200d <- c(sum(!is.na(as.matrix(finalData.noMiss.t0Jul2016.switchDTG.wt200d %>%
                                      filter(DTGOn_0 == 0) %>%
...
#                                       select(Weight_8))), na.rm = T))
n1.wt200d <- c(sum(!is.na(as.matrix(finalData.noMiss.t0Jul2016.switchDTG.wt200d %>%
                                      filter(DTGOn_0 == 1) %>%
                                      select(Weight_1))), na.rm = T),
               sum(!is.na(as.matrix(finalData.noMiss.t0Jul2016.switchDTG.wt200d %>%
...
nrow.finalData.noMiss.t0Jul2016.switchDTG.wt200d.scaled <- nrow(finalData.noMiss.t0Jul2016.switchDTG.wt200d.scaled)

df.eff.wt200d <- 
  foreach(iters.boot.i = 1:iters.boot,
          .combine   = rbind) %dopar% {
            
            tmp.finalData.noMiss.t0Jul2016.switchDTG.wt200d.scaled <- finalData.noMiss.t0Jul2016.switchDTG.wt200d.scaled[sample(1:nrow.finalData.noMiss.t0Jul2016.switchDTG.wt200d.scaled, 
                                                                                                                                nrow.finalData.noMiss.t0Jul2016.switchDTG.wt200d.scaled, 
                                                                                                                                replace = TRUE), ]
            
            tmp.result.tmle.wt200d.1 <- ltmle(tmp.finalData.noMiss.t0Jul2016.switchDTG.wt200d.scaled %>%
                                            select(male:Weight_1), 
                                          Anodes = paste0("DTGOn_", 0), 
                                          Cnodes = paste0("censor_", 0),
                                          # Lnodes = c(25:34, 38:47, 51:60),
            ...
            # time 2
            tmp.result.tmle.wt200d.2 <- ltmle(tmp.finalData.noMiss.t0Jul2016.switchDTG.wt200d.scaled %>%
                                            select(male:Weight_2), 
                                          Anodes = paste0("DTGOn_", 0:1), 
                                          Cnodes = paste0("censor_", 0:1),
                                          Lnodes = c(paste0(vary.cov.int.used, "_1")),
            ...
            # time 3
            tmp.result.tmle.wt200d.3 <- ltmle(tmp.finalData.noMiss.t0Jul2016.switchDTG.wt200d.scaled %>%
                                            select(male:Weight_3), 
                                          Anodes = paste0("DTGOn_", 0:2), 
                                          Cnodes = paste0("censor_", 0:2),
                                          Lnodes = c(paste0(vary.cov.int.used, "_1"), paste0(vary.cov.int.used, "_2")),
            ...
            # time 4
            tmp.result.tmle.wt200d.4 <- ltmle(tmp.finalData.noMiss.t0Jul2016.switchDTG.wt200d.scaled %>%
                                            select(male:Weight_4), 
                                          Anodes = paste0("DTGOn_", 0:3), 
                                          Cnodes = paste0("censor_", 0:3),
                                          Lnodes = c(paste0(vary.cov.int.used, "_1"), paste0(vary.cov.int.used, "_2"), paste0(vary.cov.int.used, "_3")),
...
summ.wt200d.all <- summ.wt200d.all %>%
  mutate(n_all = apply(finalData.noMiss.t0Jul2016.switchDTG.wt200d.scaled %>%
...
save(n1.wt200d, n0.wt200d, 
     ...
     file = "../../Data/Data20210512/Processed/WtAvgTrtEff200dCi20220512.RData")

load("../../Data/Data20210512/Processed/WtAvgTrtEff200dCi20220512.RData")
...
save(summ.wt200d.avgTrjctr, summ.wt200d.diffTrjctr,
     file = "../../Data/Data20210512/Processed/WtAvgTrtEff200dCiTrjctr20220512.RData")
...
pdf("../../Report/Manuscript20220706/WtAvgTrtEff200dCiTrjctr20220712.pdf", width = 7, height = 3.5)
grid.arrange(p3, p4, nrow = 1)
dev.off()

tiff("../../Report/CROI//WtAvgTrtEff200dCiTrjctr20230131.tiff", units="in", width=6.5, height=2.7, res=300)
grid.arrange(p3, p4, nrow = 1)
dev.off()
