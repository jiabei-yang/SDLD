...
# head(ampath.visit.wt200d.sbgrpWt)
...
#############################
table(subData.nomiss.wt200d.sbgrpWt.resPop$artStatus)
...
# colnames(subData.nomiss.wt200d.sbgrpWt.resPop.scaled)
# table(subData.nomiss.wt200d.sbgrpWt.resPop.scaled$enroll_after20160701)
...
######################################################################################
set.seed(a[opt$seed])
trt.ind.wt200d <- which((subData.nomiss.wt200d.sbgrpWt.resPop.scaled$DTGOn_0 == 1) & (subData.nomiss.wt200d.sbgrpWt.resPop.scaled$DTGOn_1 == 1) & 
                          (subData.nomiss.wt200d.sbgrpWt.resPop.scaled$DTGOn_2 == 1) & (subData.nomiss.wt200d.sbgrpWt.resPop.scaled$DTGOn_3 == 1) & 
                          (!is.na(subData.nomiss.wt200d.sbgrpWt.resPop.scaled$Weight_4))) 
ctrl.ind.wt200d <- which((subData.nomiss.wt200d.sbgrpWt.resPop.scaled$DTGOn_0 == 0) & (subData.nomiss.wt200d.sbgrpWt.resPop.scaled$DTGOn_1 == 0) & 
                           (subData.nomiss.wt200d.sbgrpWt.resPop.scaled$DTGOn_2 == 0) & (subData.nomiss.wt200d.sbgrpWt.resPop.scaled$DTGOn_3 == 0) & 
                           (!is.na(subData.nomiss.wt200d.sbgrpWt.resPop.scaled$Weight_4))) 
n.pts.wt200d          <- nrow(subData.nomiss.wt200d.sbgrpWt.resPop.scaled)
...
data.bl.wiz.rownumb <- data.frame(rownumb = 1:length(tree.train.ind.wt200d),
                                  train.data.wt200d[, c("male", "arvstart_dob", "time0_dob", 
                                                        ...
                                                        "time0_arvstart", "artStatus", "enroll_after20160701", "Weight_0", paste0(vary.cov.int.used, "_0"))])
...
save(subData.nomiss.wt200d.sbgrpWt.resPop.scaled,
     tree.ind.wt200d, tree.train.ind.wt200d, tree.test.ind.wt200d, ci.ind.wt200d,
     large.tree.wt200d, 
     file = paste0("../../../Data/Data20210512/Processed/TreeRes20230304/WtSubAnal200dAllStp1_seed", opt$seed, 
                   "_20230304.RData"))
