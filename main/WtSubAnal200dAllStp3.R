...
# cor(subData.nomiss.wt200d.sbgrpWt.resPop$arvstart_dob, subData.nomiss.wt200d.sbgrpWt.resPop$time0_dob)
# cor(subData.nomiss.wt200d.sbgrpWt.resPop$time0_arvstart, subData.nomiss.wt200d.sbgrpWt.resPop$time0_dob)
# cor(subData.nomiss.wt200d.sbgrpWt.resPop$time0_arvstart, subData.nomiss.wt200d.sbgrpWt.resPop$arvstart_dob)


# # there are participants who start arv after time 0, time0_arvstart 0
# identical(subData.nomiss.wt200d.sbgrpWt.resPop$time0_dob - subData.nomiss.wt200d.sbgrpWt.resPop$arvstart_dob,
#           subData.nomiss.wt200d.sbgrpWt.resPop$time0_arvstart)
...
# table(subData.nomiss.wt200d.sbgrpWt.resPop[which(subData.nomiss.wt200d.sbgrpWt.resPop$time0_dob - subData.nomiss.wt200d.sbgrpWt.resPop$arvstart_dob !=
#                                                     subData.nomiss.wt200d.sbgrpWt.resPop$time0_arvstart), "time0_arvstart"])
# sum(subData.nomiss.wt200d.sbgrpWt.resPop$time0_dob - subData.nomiss.wt200d.sbgrpWt.resPop$arvstart_dob !=
#                                                     subData.nomiss.wt200d.sbgrpWt.resPop$time0_arvstart)
# sum(subData.nomiss.wt200d.sbgrpWt.resPop$time0_dob == subData.nomiss.wt200d.sbgrpWt.resPop$arvstart_dob)
# dim(subData.nomiss.wt200d.sbgrpWt.resPop$time0_dob)
...
save(df.fnlTr.frstSplt.ind, df.fnlTr.othrSplt.ind, size.fnlTr, 
     ind.tree.size2, ind.tree.size3, 
     ind.tree.size2.male, ind.tree.size3.genderDob,
...
n.iters.i <- ind.tree.size3.genderMaleDob[3]
load(paste0("../../../Data/Data20210512/Processed/TreeRes20230304/WtSubAnal200dAllStp2_seed", n.iters.i, "_20230304.RData"))
tmp.fnlTr <- final.tree.list.wt200d[[1]][4][[1]]
tmp.fnlTr
