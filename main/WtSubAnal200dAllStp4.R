...
# n.iters.i <- ind.tree.size3.genderMaleDob[33]
...
# mean((tree.data.wt200d$male == 1) & (tree.data.wt200d$time0_dob < final.tree.wt200d$splits[2, "index"]))
# mean((tree.data.wt200d$male == 1) & (tree.data.wt200d$time0_dob >= final.tree.wt200d$splits[2, "index"]))
# mean((tree.data.wt200d$male == 1) & (tree.data.wt200d$time0_dob < final.tree.wt200d$splits[2, "index"])) +
#   mean((tree.data.wt200d$male == 1) & (tree.data.wt200d$time0_dob >= final.tree.wt200d$splits[2, "index"]))
...
# mean((subData.nomiss.wt200d.sbgrpWt.resPop.scaled$male == 1) & (subData.nomiss.wt200d.sbgrpWt.resPop.scaled$time0_dob < final.tree.wt200d$splits[2, "index"]))
# mean((subData.nomiss.wt200d.sbgrpWt.resPop.scaled$male == 1) & (subData.nomiss.wt200d.sbgrpWt.resPop.scaled$time0_dob >= final.tree.wt200d$splits[2, "index"]))
...
colnames(df.eff.wt200d.nodes) <- c("all", "node2", "node3")
...
save(summ.wt200d.node1, summ.wt200d.node2, summ.wt200d.node3, 
     ...
     file = "../../../Data/Data20210512/Processed/WtSubAnal200dAllStp4_20230410.RData")
